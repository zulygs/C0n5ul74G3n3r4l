...
if ($user=='vaniad'|| $user=='sistemas'|| $user=='lrodriguez'|| $user=='ycifuentes'|| $user=='ecorzo'|| $user=='ccorado'|| $user=='cmiranda'||$user=='evelasquez') {
      $user=$user;
    }
...
$clav=$_COOKIE['clav'];
 ...
 $va='';
    ...
    $clav  = md5(mysqli_real_escape_string($con, $_POST['pass']));
    if ($user=='vaniad'|| $user=='sistemas'|| $user=='lrodriguez'|| $user=='ecorzo'|| $user=='ccorado'|| $user=='cmiranda'||$user=='evelasquez') {
      $va=$user;
    }
  ...
  <div class= "container container-form">
    ...
    <form class="form needs-validation" novalidate method="POST" action="login.php">
      <div class="form-group">
        ...
        <input type="text" name="usuario" id="user-group" class="form-control" placeholder="Usuario" value="<?php
