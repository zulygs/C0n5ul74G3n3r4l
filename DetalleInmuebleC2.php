...
if ($Nuser=="Vaniad" || $_SESSION['user'] =="admin") {
...
if ($_SESSION['user'] =="admin") {
    ...
    echo "<a id='' class='btn  btn-lg' href='Consulta.php' style='background-color: #1883ba;height:50px'><font color='white'>Servicios</font></a>";
...
if ($_SESSION['user'] =='Vaniad'|| $_SESSION['user'] =='admin' || $_SESSION['idUser'] == 387 || $_SESSION['idUser'] ==391 || $_SESSION['idUser'] ==382 || $_SESSION['idUser'] ==321 || $_SESSION['idUser'] ==386 || $_SESSION['idUser'] ==21) {
            ...
            ?>
               <?php 
            if ($_SESSION['user'] =='Vaniad'|| $_SESSION['user'] =='admin') {
				/* echo "<div class='form-group margen'>
 <button class='btn btn-secondary btn-lg' name='' id='' ><a href='ServicioV.php'><font color='white'>Solicitudes </font></a></button>
 </div>";*/
           echo "<a id='' class='btn  btn-lg' href='ServicioV.php' style='background-color: #21cbde;height:50px'><font color='white'>Solicitudes</font></a>"; 
			?>
          <?php }
          echo "<a id='' class='btn  btn-lg' href='ConsultaRecone.php' style='background-color: #1883ba;height:50px'><font color='white'>Consulta Reconexiones</font></a>"; ?>
            <div class="form-group margen">
